    ...
    <PolicyLayout title="Cookie Policy" lastUpdated="January 20, 2026">
      ...
      <section>
        ...
        <p>
          ...
          See{" "}
          <a href="https://stripe.com/cookies-policy" target="_blank" rel="noopener noreferrer" className="text-cyan-400 hover:underline">
        ...
        <p>
          ...
          See{" "}
          <a href="https://www.youtube.com/t/privacy" target="_blank" rel="noopener noreferrer" className="text-cyan-400 hover:underline">
