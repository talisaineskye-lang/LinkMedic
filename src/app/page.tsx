...
export default async function Home() {
  ...
  return (
    <main className="min-h-screen bg-zinc-950">
      {/* Fixed Navigation */}
      <nav className="fixed top-0 left-0 right-0 z-50 bg-zinc-950/80 backdrop-blur-md border-b border-zinc-900 py-4 px-6">
        <div className="max-w-6xl mx-auto flex justify-between items-center">
          ...
          <Link
            href="/audit"
            className="rounded-lg bg-green-500 text-zinc-950 px-4 py-2 text-sm font-medium hover:bg-green-400 transition shadow-[0_0_15px_rgba(34,197,94,0.3)]"
          >
            Scan My Channel
          </Link>
        </div>
      ...
      {/* The Problem */}
      <section id="problem" className="bg-zinc-950 py-24 border-t border-zinc-900">
        <div className="max-w-4xl mx-auto px-6">
          ...
          <p className="text-zinc-500 text-center mb-16">
            Products get discontinued. URLs change. Nobody tells you.
          </p>
      ...
      <section className="bg-zinc-900 py-24">
        <div className="max-w-4xl mx-auto px-6">
          <h2 className="text-2xl md:text-3xl font-semibold text-zinc-100 text-center mb-4">
            A simple list of what needs fixing.
          </h2>
          <p className="text-zinc-500 text-center mb-16">
            No dashboards. No complexity. Just the stuff you need to fix.
          </p>

          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-zinc-800/50 rounded-xl p-6">
              <h3 className="text-zinc-100 font-medium mb-2">Weekly scans</h3>
              <p className="text-zinc-500 text-sm">
            ...
            <div className="bg-zinc-800/50 rounded-xl p-6">
              ...
              <p className="text-zinc-500 text-sm">
                Bulk export your broken links and fix them in minutes.
              </p>
            </div>
        ...
        <div className="max-w-5xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-zinc-800/50 rounded-2xl p-8">
              ...
              <Link href="/audit" className="block text-center rounded-xl border border-zinc-600 text-zinc-300 px-6 py-3 hover:border-zinc-400 transition">
                Start Free
              </Link>
            </div>

            {/* Specialist tier */}
            <div className="bg-zinc-800/50 rounded-2xl p-8 ring-2 ring-green-500/50">
              ...
              <Link href="/login" className="block text-center rounded-xl bg-green-500 text-zinc-950 px-6 py-3 font-medium hover:bg-green-400 transition shadow-[0_0_15px_rgba(34,197,94,0.3)]">
                Start Free Trial
              </Link>
            </div>
      ...
      <section className="bg-zinc-950 py-24 border-t border-zinc-900">
        <div className="max-w-2xl mx-auto px-6 text-center">
          ...
          <Link
            href="/audit"
            className="inline-block rounded-xl bg-green-500 text-zinc-950 px-8 py-4 font-semibold hover:bg-green-400 transition shadow-[0_0_20px_rgba(34,197,94,0.3)]"
          >
            Scan My Channel
          </Link>
        </div>
