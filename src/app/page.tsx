    ...
    <main className="min-h-screen bg-white">
      ...
      <header className="border-b border-gray-100">
        <div className="max-w-5xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-0.5 text-xl font-semibold text-gray-900">
            <span>Link</span>
      ...
      <section className="max-w-3xl mx-auto px-6 pt-20 pb-16 text-center">
        {/* Centered Logo */}
        <div className="flex items-center justify-center gap-0.5 text-4xl font-semibold text-gray-900 mb-6">
          <span>Link</span>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-md mx-auto px-6">
          <div className="border border-gray-200 rounded-lg p-8 text-center">
            <div className="flex items-center justify-center gap-0.5 text-xl font-semibold text-gray-900 mb-2">
              <span>Link</span>
              <LinkIcon className="w-5 h-5 text-green-700" />
              <span>Medic</span>
            </div>
