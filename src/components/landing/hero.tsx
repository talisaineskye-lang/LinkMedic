...
export function Hero() {
  return (
    <section className="min-h-screen bg-zinc-950 text-zinc-100 flex items-center justify-center px-6 py-20 pt-32">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 max-w-6xl w-full">
        ...
        <div className="flex flex-col justify-center">
          ...
          <p className="text-zinc-500 max-w-md mb-8">
            We quietly check your YouTube affiliate links every week so you don&apos;t have to.
          </p>

          <Link
            href="/audit"
            className="w-fit rounded-xl bg-green-500 text-zinc-950 px-8 py-4 font-semibold hover:bg-green-400 transition shadow-[0_0_20px_rgba(34,197,94,0.3)]"
          >
            Run a Channel Scan
          </Link>
